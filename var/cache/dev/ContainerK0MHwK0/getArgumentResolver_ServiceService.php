...
return $this->privates['argument_resolver.service'] = new \Symfony\Component\HttpKernel\Controller\ArgumentResolver\ServiceValueResolver(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Controller\\AddController:profile' => function () {
    return ($this->privates['service_locator.Duiq94b'] ?? $this->load(__DIR__.'/getServiceLocator_Duiq94bService.php'));
...
}, 'App\\Controller\\AddController::profile' => function () {
    return ($this->privates['service_locator.Duiq94b'] ?? $this->load(__DIR__.'/getServiceLocator_Duiq94bService.php'));
}, 'App\\Controller\\DefaultController::index' => function () {
    return ($this->privates['service_locator.OXGnpIQ'] ?? $this->load(__DIR__.'/getServiceLocator_OXGnpIQService.php'));
}, 'App\\Controller\\DefaultController::indexa' => function () {
